...
exports.PrescriptionModule = PrescriptionModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [prescription_service_1.PrescriptionService, prescription_repository_1.PrescriptionRepository],
        exports: [prescription_service_1.PrescriptionService, prescription_repository_1.PrescriptionRepository],
    })
], PrescriptionModule);

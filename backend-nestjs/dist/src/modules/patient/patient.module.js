...
exports.PatientModule = PatientModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [patient_service_1.PatientService, patient_repository_1.PatientRepository],
        exports: [patient_service_1.PatientService, patient_repository_1.PatientRepository],
    })
], PatientModule);

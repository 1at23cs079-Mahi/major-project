...
export const useInterview = () => {
  ...
  const speechToText = useMutation({
    mutationFn: async ({ audioBlob, provider = 'deepgram', language = 'en' }: { audioBlob: Blob; provider?: 'deepgram' | 'whisper'; language?: string }) => {
      ...
      const { data, error } = await supabase.functions.invoke('speech-to-text', {
        body: { audio: base64Audio, provider, language },
      });
